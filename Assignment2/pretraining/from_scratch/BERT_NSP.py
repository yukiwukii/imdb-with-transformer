...
import os
import tokenizers
from transformers import BertTokenizer, BertConfig, BertForMaskedLM, DataCollatorForLanguageModeling, Trainer, TrainingArguments, EarlyStoppingCallback, BertForPreTraining
import random
...
class DataCollatorForBertPretraining:
    ...
    def __call__(self, examples):
        ...
        batch = {
            ...
            "next_sentence_label": torch.tensor([example["label"] for example in examples])
        }
